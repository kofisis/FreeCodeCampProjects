...
var denom = [
   ...
   * Next, transform the CID array into a drawer object. Then, handle the conditions of exact change and insufficient funds. 
   * Loop through the denom array and update the change and values while there is still money of each type in the drawer and while the denomination is larger than the change remaining. 
   ...
   * Finally you can give the correct change.
   *  Return the output object with a status of OPEN and change_arr as the value of change.
   */